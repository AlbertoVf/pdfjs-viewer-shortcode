...
//BUG: la vista se visualiza en todas las paginas. Modificar para que solo se vea en Back-end;
function pdfjs_media_button()
{
    // echo '<div class="wp-menu-name" style="text-align:right; margin:0.5% 20px;"> <a href="' . plugins_url() . '/pdfjs-viewer-shortcode/lib/pdfjs-insert.php" target="_target" id="insert-pdfjs" class="button">PDF Viewer</a> </div>';

    echo ('
    <div class="mt-2 mr-4 mb-2 ml-2 d-flex justify-content-end">
                        ...
                        <form id="form" action="lib/sobreescribir/index.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <select class="custom-select" id="categorias-select" name="categorias-select">
                                    <?php include_once("lib/pdfjs-rutas.php"); seleccionar_almacenamiento($ruta_docs); ?>
                                </select>
                            </div>
